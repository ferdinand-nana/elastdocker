...
ES_IMAGE_DOCKER_TAG="$KSD_ES_IMAGE_NAME:$KSD_ES_VERSION-$ELK_VERSION-$KSD_TARGET_IMAGE_ARCH"
...
KIBANA_IMAGE_DOCKER_TAG="$KSD_KIBANA_IMAGE_NAME:$KSD_ES_VERSION-$ELK_VERSION-$KSD_TARGET_IMAGE_ARCH"
